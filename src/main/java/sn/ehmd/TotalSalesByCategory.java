...
/**
 * Analyse 2 — CA total par catégorie de produit (champ index 3), montant en index 4.
...
public class TotalSalesByCategory {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "Total CA par categorie");
